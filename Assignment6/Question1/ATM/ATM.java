...
public class ATM {
            ...
            if (! user.getPassword().equals(passWord)) {
                ...
                while (true) {
                    ...
                    if (input.equals("1")) {
                        ...
                        for (String s : transaction.get(bankAccountNumber)) {
                            if (transaction.get(bankAccountNumber).indexOf(s) <= 9 ) {
    ...
    private void withdrawal(String bankAccountNumber) {
        ...
        if (Double.valueOf(withdrawal) > user.getAvaileBalance()) {
            ...
            return;
        } else if (Double.valueOf(withdrawal) > availableAmountInMachine) {
            ...
            record.add("WITHDRAWAL " +  withdrawal + "  TRANSACTION FEE:  -" + getTransactionFee());
            transaction.put(bankAccountNumber, record);
    ...
    private void deposit(String bankAccountNumber) {
        ...
        record.add("DEPOSIT: " +  deposit + "  TRANSACTION FEE:  -" + getTransactionFee());
        transaction.put(bankAccountNumber, record);
